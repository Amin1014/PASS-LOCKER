...
class TestCredentials(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credentials.credentials_name,"Amin")
        self.assertEqual(self.new_credentials.usr_name,"Moha")
        self.assertEqual(self.new_credentials.password,"123456")
        self.assertEqual(self.new_credentials.email,"moha.m@.com")
